...
use App\Http\Controllers\Frontend\PreRegistroController;
...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    */
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::post('preregistro/store', [PreRegistroController::class, 'store'])->name('preregistro.store');
        Route::get('preregistro/getComunas', [PreRegistroController::class, 'getComunas'])->name('preregistro.getComunas');
