...
@section('content')
{{ html()->modelForm($clienteProveedor, 'PATCH', route('admin.cliente_proveedor.update',$clienteProveedor))->class('form-horizontal')->open() }}
      <div>
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="mail-body text-right tooltip-demo">
                                ...
                                <a class="btn btn-white btn-sm" href="{{route('admin.cliente_proveedor.index')}}" >@lang('buttons.general.cancel')</a>
