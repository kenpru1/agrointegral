...
@section('content')
{{ html()->modelForm($guia, 'PATCH', route('admin.guia_despachos.update',$guia))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
     <div>
                               ...
                               <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 ">
                                        ...
                                        <input type="text" class="form-control" name="nota_publica" value="{{$guia->nota_publica  }}" maxlength="100">
                                    </div>
                                <div class="form-group col-md-5 col-md-push-1">
                                    {{ html()->label('Nota Privada')->for('nota_privada') }}
                                        <input type="text" class="form-control" name="nota_privada" value="{{$guia->nota_privada  }}" maxlength="100">
                                </div>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <div class=" col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-group m-b"><span class="input-group-addon">$</span> 
                                            <input class="form-control" type="number" name="sub_total" id="sub_total" value="{{number_format($guia->sub_total,2,'.','')}}" readonly></div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-group m-b"><span class="input-group-addon">$</span> 
                                            <input type="number" class="form-control" id="iva" name="iva" readonly value="{{  number_format( $guia->iva,2,'.','')}}">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-group m-b"><span class="input-group-addon">$</span> 
                                            <input type="number" class="form-control" id="total_guia" name="total_guia" value="{{  number_format( $guia->total,2,'.','') }}" readonly>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
function calcular(){
    ...
    $("#total_guia").val(totPres.toFixed(2));
 }
