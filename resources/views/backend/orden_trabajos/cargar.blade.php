                            ...
                            <form class="form-horizontal">
                               ...
                               <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="date" class="form-control"  id="fecha" name="fecha" value={{ isset($presupuesto->fecha)?$presupuesto->fecha:date('Y-m-d') }} required>
                           
                                    </div>

                                    <div class="form-group col-md-5 col-md-push-1">
                                        {{ html()->label('Fecha entrega')->for('fecha_entrega') }}
                                        <input type="date" class="form-control"  id="fecha_entrega" name="fecha_entrega" value={{ isset($presupuesto->fecha_entrega)?$presupuesto->fecha_entrega:date('Y-m-d') }} required>
                                    </div><!--form-group-->
                               ...
                               <div class="row">
                                    ...
                                    <div class="form-group col-md-5 ">
                                        ...
                                        {{ html()->select('cliente_id', $clientes,isset($presupuesto->cliente_id)?$presupuesto->cliente_id:null)
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        {{ html()->select('contacto_id', $contactos,isset($presupuesto->empresa_contacto_id)?$presupuesto->empresa_contacto_id:null)
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                {{ html()->select('especies', $especies,isset($detallePre->especie_fuente_id)?$detallePre->especie_fuente_id:null)
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {{ html()->select('muestas', $muestras,isset($detallePre->tipo_muestra_id)?$detallePre->tipo_muestra_id:null)
                                                ->placeholder('Seleccione')
                                                ->class('form-control chosen-select')
                                                ->id('muestra') }}                      
                                            ...
                                            <td>
                                                ...
                                                {{ html()->select('analisis', $analisis,isset($detallePre->analisis_id)?$detallePre->analisis_id:null)
                                                ->placeholder('Seleccione')
                                                ->class('form-control chosen-select')
                                                ->id('analisis') }}                                                                     
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                {{ html()->select('laboratorios', $laboratorios,isset($detallePre->laboratorio_id)?$detallePre->laboratorio_id:null)
                                                ->placeholder('Seleccione')
                                                ->class('form-control chosen-select')
                                                ->id('laboratorio') }}                                                                     
                                            </td>
