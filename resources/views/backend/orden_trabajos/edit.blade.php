...
@section('content')
{{ html()->modelForm($ordenTrabajo, 'PATCH', route('admin.ordenTrabajos.update',$ordenTrabajo))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div>
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Editar Orden de Trabajo | Nro. :
                                <b> {{ $ordenTrabajo->numero }}</b>
                            </h5>                            
