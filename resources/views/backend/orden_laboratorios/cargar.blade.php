...
@section('content')
{{ html()->modelForm($ordenTrabajo, 'POST', route('admin.ordenLaboratorios.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div>
                            ...
                            <form class="form-horizontal">
                               ...
                               <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="date" class="form-control"  id="fecha" name="fecha" value={{ isset($ordenTrabajo->fecha)?$ordenTrabajo->fecha :date('Y-m-d') }} required>
                               ...
                               <div class="row">
                                    ...
                                    <div class="form-group col-md-5 ">
                                        ...
                                        {{ html()->select('cliente_id', $clientes,isset($ordenTrabajo->cliente_id)? $ordenTrabajo->cliente_id:null)
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        {{ html()->select('contacto_id',$contactos,isset($ordenTrabajo->empresa_contacto_id)?$ordenTrabajo->empresa_contacto_id:null)
