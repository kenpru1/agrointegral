            ...
            <form class="form-horizontal">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5 col-md-push-1">
                        ...
                        <input class="form-control" type="text" id="rut" name="rut" readonly value="{{$proveedor->rut}}" >
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-5">
                        ...
                        <input class="form-control" type="date" name="fecha" value="{{$actividadGasto->fecha->format('Y-m-d')  }}">
                    </div>
                    <div class="form-group col-md-5 col-md-push-1">
                        {{ html()->label('Periodo')->for('periodo') }}
                        <input class="form-control" type="month" name="periodo" value="{{ $actividadGasto->periodo  }}">
                    </div>
                ...
                <div class="row">
                    <table id="table_labores" class="table table-striped table-bordered table-hover">
                        <tbody>
                                        ...
                                        <table id="table_modal" class="table table-striped table-bordered table-hover">
                                            ...
                                            @foreach($actividad->cuarteles as $cuartel)
                                               <tr>
                                                  ...
                                                  <td><input class="cuartel_input" type="number" min=0 maxlength="7" step="any"  value=0 name="{{ $cuartel->nombre }}" cuartelId="{{ $cuartel->id }}"  ></td>
                                                </tr>
                                            @endforeach
                                        </table>
                                    </div>
                            ...
                            <tr lineid={{$lineId}}>
                                <td> {{$labor->labor }} <input type="hidden"  value="{{$labor->labor }}" name="labor_array[]"></td>
                                ...
                                <td> <a href="#" class="borrar_labores btn btn-success" data-toggle="tooltip" lineid={{$lineId}} title="Eliminar"><i class="fa fa-minus"></i></a></td>
                    ...
                    <input type="hidden" id="numero_labores" name="numero_labores" value="{{ $numero_labores}}">
                </div>
...
@section('scripts')
<script>
var numero_labores={{ $numero_labores }};
