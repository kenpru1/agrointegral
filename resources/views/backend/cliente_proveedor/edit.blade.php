...
@if( request()->route()->getName() == 'admin.cliente.edit')
    @section('title', __('labels.backend.access.clientes.management') . ' | Editar' )
@else
    @section('title', __('labels.backend.access.proveedor.management') . ' | Editar' )
@endif
...
@else
    {{ html()->modelForm($clienteProveedor, 'PATCH', route('admin.proveedor.update',$clienteProveedor))->class('form-horizontal')->open() }}
@endif
                                ...
                                <div class="form-group col-md-5 col-md-push-1">
                                    {{ html()->label('Paises')->for('pais_id') }}
                                     {{ html()->select('pais_id', $paises,46)
                                        ->placeholder('Seleccione Pais chosen-select', false)
                               ...
                               <div class="row">
                                ...
                                <div class="form-group col-md-5 col-md-push-1">
                                     ...
                                     {{ html()->select('comuna_id', $comunas,null)
                                          ->placeholder('Seleccione Comuna chosen-select', false)
                                          ->class('form-control')
                                          ->required()
                                          ->id('comuna_id') }}
                                </div><!--form-group-->
