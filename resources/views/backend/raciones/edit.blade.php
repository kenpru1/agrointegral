               ...
               <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-5">
                        ...
                        <input type="date" class="form-control" name="fecha" value="{{isset($racion->fecha)?$racion->fecha->format('Y-m-d'):date('Y-m-d') }}">
                ...
                <div class="row">
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" class="form-control" name="nombre" maxlength="100" value="{{ $racion->nombre }}">
                    </div>
