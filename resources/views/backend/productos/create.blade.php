...
@section('content')
{{ html()->form('POST', route('admin.productos.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div>
                            ...
                            <form class="form-horizontal">
                               ...
                               <div class="row">
                                ...
                                <div class="form-group col-md-5 ">
                                    ...
                                    <input type="number" class="form-control" name="precio_venta" min="0" step="any">
                                </div>
                                <div class="form-group col-md-5 col-md-push-1">
                                    {{ html()->label('Precio Compra')->for('precio_compra') }}
                                    <input type="number" class="form-control" name="precio_compra" min="0" step="any">
                                </div>
