                            ...
                            <form class="form-horizontal">
                              ...
                              <div class="row">
                                ...
                                <div class="form-group col-md-5 ">
                                    ...
                                    <input type="number" class="form-control" name="precio_venta" min="0" step="any" value="{{$producto->precio_venta}}">
                                </div>
                                <div class="form-group col-md-5 col-md-push-1">
                                    {{ html()->label('Precio Compra')->for('precio_compra') }}
                                    <input type="number" class="form-control" name="precio_compra" min="0" step="any" value="{{$producto->precio_compra}}">
                                </div>
