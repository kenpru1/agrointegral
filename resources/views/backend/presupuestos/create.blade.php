...
@section('content')
{{ html()->form('POST', route('admin.presupuestos.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div>
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Crear Cotización | Nro. Provisional:
                                <b> {{ $nroProv }}</b>
                            </h5>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" class="form-control" id="precio_venta" name="precio_venta" min="0" step="1" required> </div>
