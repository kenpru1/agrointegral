...
@section('title', 'Requerimientos' . ' | ' . 'Cambiar Etapa Aprobada')

@section('content')
    {{ html()->modelForm($requerimiento, 'GET', route('admin.requerimientos.asociarOrdenTrabajo', $requerimiento))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
        <div>
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Administración de Requerimientos
                        <small class="text-muted">Cambiar Etapa Aprobada</small>
                    </h5>                               
                </div>
                <div class="ibox-content">
                    <form class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group col-md-5">
                                {{ html()->label('Seleccionar Orden de Trabajo')
                                    ->for('orden_trabajo_id') }}
                                @if($requerimiento->orden_trabajo_id != null)
                                    {{ html()->select('orden_trabajo_id', $ordenTrabajos, null)
                                ...
                                @else
                                    {{ html()->select('orden_trabajo_id', $ordenTrabajos, null)
                                    ->placeholder('Seleccione Nro. Orden de Trabajo', null)
                                    ->class('form-control  chosen-select')
                                    ->required()
                                    ->id('orden_trabajo_id')
                                     }}
                            ...
                            <div class="form-group col-md-5 col-md-push-1">
                                <a href="{{ route('admin.ordenTrabajos.create') }}" class="pull-center btn btn-xs btn-blue">Crear Orden de Trabajo</a> 
                                <br> 
