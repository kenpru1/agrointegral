...
@section('title',  'Bodegas | Crear' )

@section('content')
{{ html()->form('POST', route('admin.bodegas.store'))->class('form-horizontal')->open() }}
    <div>
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Administrador de Bodegas
                                <small class="text-muted">Crear Bodegas</small>
                            </h5>
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group col-md-5 col-md-push-1">
                                    ...
                                    <input type="text" class="form-control" name="direccion" maxlength="190" >
                               ...
                               <div class="row">
                                ...
                                {{--<div class="row">
                                    <div class="form-group col-md-5">
                                        <input type="checkbox" name="propio" value="1"/> Propio
                                    </div><!--form-group-->
                                </div>--}}
