...
@section('title', 'Trabajador | Crear' )

@section('content')
{{ html()->form('POST', route('admin.trabajadores.store'))->class('form-horizontal')->open() }}
    <div>
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                               <div class="row">
                                ...
                                <div class="row">
                                {{--<div class="form-group col-md-5">
                                    {{ html()->label('No. Carnet')->for('numero_carnet') }}
                                    {{ html()->text('numero_carnet')
                                        ->class('form-control')
                                ...
                                <div class="form-group col-md-5 ">
                                    <input type="checkbox" name="asesor" value="1" > Asesor
                                </div><!--form-group-->
