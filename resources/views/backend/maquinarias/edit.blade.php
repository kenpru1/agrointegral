...
@section('title', 'Maquinaria | Editar' )
            ...
            <form class="form-horizontal">
                <div class="row">
                    ...
                    <div class="form-group col-md-5 col-md-push-1">
                        ...
                        <input class="form-control" min="0" name="valor_compra" step="any" type="number" value="{{$maquinaria->valor_compra}}">
                        </input>
                ...
                <div class="row">
                    <div class="form-group col-md-5">
                        ...
                        <input class="form-control" name="fecha_compra" type="date" value="{{isset($maquinaria->fecha_compra) ?$maquinaria->fecha_compra->format('Y-m-d'):null}}">
                        </input>
                    </div>
                    <div class="form-group col-md-5 col-md-push-1">
                       
                        {{ html()->label('Vencimiento Rev. Técnica')->for('venc_rev_tecnica') }}
                        <input class="form-control" name="venc_rev_tecnica" type="date" value="{{isset($maquinaria->venc_rev_tecnica) ?$maquinaria->venc_rev_tecnica->format('Y-m-d'):null}}">
                        </input>
                ...
                <div class="row">
                    <div class="form-group col-md-5">
                        ...
                        <input class="form-control" name="fecha_inspeccion" type="date" value="{{isset($maquinaria->fecha_inspeccion) ?$maquinaria->fecha_inspeccion->format('Y-m-d'):null}}">
                        </input>
                    </div>
                    <div class="form-group col-md-5 col-md-push-1">
                        {{ html()->label('Fecha Seguro')->for('fecha_seguro') }}
                        <input class="form-control" name="fecha_seguro" type="date" value="{{isset($maquinaria->fecha_seguro) ?$maquinaria->fecha_seguro->format('Y-m-d'):null}}">
                        </input>
                    </div>
                    <!--form-group-->
                </div>
