                            ...
                            <form class="form-horizontal">
                               @if($logged_in_user->hasRole('administrator'))
                                    <div class="row">
                                        <div class="form-group col-md-5 ">
                                            ...
                                            {{ html()->select('empresa_id', $empresas,$request->empresa_id)
                               ...
                               <div class="row">
                                ...
                                <div class="form-group col-md-4 ">
                                     ...
                                     {{ html()->select('maquinaria_id', $maquinarias,$request->maquinaria_id)
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <div class="input-group"><input type="date" class="form-control" name="fecha_fin" value={{$request->fecha_fin}}><span class="input-group-btn"> <button class="btn btn-primary" type="submit">Consultar</button></span></div>
