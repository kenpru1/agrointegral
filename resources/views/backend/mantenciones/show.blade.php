            ...
            <form class="form-horizontal">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5 col-md-push-1">
                        ...
                        <input class="form-control" id="costo" min="0" name="costo" readonly="" required="" step="1" type="number" value="{{ $mantencion->costo }}" readonly>
                        </input>
                    </div>
                    <!--form-group-->
                </div>
                <div class="row">
                    <div class="form-group col-md-5">
                        ...
                        <input class="form-control" name="fecha" type="date" value="{{isset($mantencion->fecha)?$mantencion->fecha->format('Y-m-d'):null}}" readonly>
                        </input>
                    </div>
                    <div class="form-group col-md-5 col-md-push-1">
                        {{ html()->label('IVA')->for('iva') }}
                        <input class="form-control" id="iva" min="0" name="iva" readonly="" required="" step="1" type="number" value="{{ $mantencion->iva }}" readonly>
                        </input>
                    </div>
                    <!--form-group-->
                </div>
                <div class="row">
                    <div class="form-group col-md-5 ">
                        ...
                        {{ html()->select('empresa_id', $clienProv, $mantencion->cliente_proveedor_id)
                            ...
                            <input class="form-control" id="nombre_razon"  name="nombre_razon" readonly type="text" value="{{$mantencion->cliente_proveedor_id!=null? $mantencion->cliente_proveedor->nombre_razon:'' }}" readonly>
                    ...
                    <div class="form-group col-md-5 col-md-push-1">
                        ...
                        <input class="form-control" id="total_iva" min="0" name="total_iva" required="" step="1" type="number" value="{{ $mantencion->total_iva }}"  {{ $mantencion->factura_recibida_id!=null ? 'readonly' : '' }} readonly>
                        </input>
                    </div>
                    <!--form-group-->
                </div>
