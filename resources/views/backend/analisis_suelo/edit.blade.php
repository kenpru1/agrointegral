...
@section('title',  'Análisis Suelo | Editar' )
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Administrador de Análisis de Suelo
                                <small class="text-muted">Editar Análisis</small>
                            </h5>
                            ...
                            <div class="tab-content">
                               ...
                               <div class="row">
                                ...
                                <div class="form-group col-md-5">
                                     ...
                                     {{ html()->select('campo_id', $campos,$campos,$analisis->cuartel->campo_id)
                                ...
                                <div class="form-group col-md-5 col-md-push-1">
                                    ...
                                    <input type="number" min="0" step="any" class="form-control" name="prof_desde" value="{{ $analisis->prof_desde }}" required>
                                </div><!--form-group-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="prof_hasta" value="{{ $analisis->prof_desde }}" required>
                                    </div><!--form-group-->
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" name="sector" class="form-control" value="{{ $analisis->sector }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="text"  class="form-control" name="arcilla" value="{{ $analisis->arcilla }}">
                                    </div><!--form-group-->
                                    <div class="form-group col-md-5 col-md-push-2">
                                        {{ html()->label('Arena')->for('arena') }}
                                        <input type="text"  class="form-control" name="arena" value="{{ $analisis->arena }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="text"  class="form-control" name="limo" value="{{ $analisis->limo }}">
                                    </div><!--form-group-->
                                    <div class="form-group col-md-5 col-md-push-2">
                                        {{ html()->label('Cond. Eléctrica')->for('cod_electrica') }}
                                        <input type="text"  class="form-control" name="cond_electrica" value="{{ $analisis->cond_electrica }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="text"  class="form-control" name="humedad" value="{{ $analisis->humedad }}">
                                    </div><!--form-group-->
                                    <div class="form-group col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="ph" value="{{ $analisis->ph }}">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-2">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="n" value="{{ $analisis->n }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="p" value="{{ $analisis->p }}">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-2">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="k" value="{{ $analisis->k }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="s" alue="{{ $analisis->s }}">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-2">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="mg" value="{{ $analisis->mg }}">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="na" value="{{ $analisis->na }}">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-2">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="ca" value="{{ $analisis->ca }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        {{ html()->label('C')->for('c') }}
                                        <input type="number" min="0" step="any" class="form-control" name="c" value="{{ $analisis->c }}">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-2">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="nitro_organico" value="{{ $analisis->nitro_organico }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="no3" value="{{ $analisis->no3 }}">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-2">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="rel_cn" value="{{ $analisis->rel_cn }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 col-md-push-1">
                                        ...
                                        <input type="number" min="0" step="any" class="form-control" name="mat_organica" value="{{ $analisis->mat_organica }}">
