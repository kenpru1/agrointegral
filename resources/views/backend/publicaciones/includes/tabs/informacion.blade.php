<div class="form-group"><label class="col-sm-2 control-label">Título:</label>
    <div class="col-sm-10"><input type="text" name="titulo" class="form-control" placeholder="Título" value="{{isset($publicacion->titulo) ? $publicacion->titulo : null}}" maxlength="50" required></div>
</div>

<div class="form-group"><label class="col-sm-2 control-label">Contacto:</label>
    <div class="col-sm-10"><input type="text" name="contacto" class="form-control" placeholder="Nombres y Apellidos" value="{{isset($publicacion->contacto) ? $publicacion->contacto : null}}" maxlength="20" required></div>
</div>

<div class="form-group"><label class="col-sm-2 control-label">Teléfono:</label>
    <div class="col-sm-10"><input type="text" name="telefono" class="form-control" placeholder="Teléfono" value="{{isset($publicacion->telefono) ? $publicacion->telefono : null}}" maxlength="20" required></div>
</div>

<div class="form-group"><label class="col-sm-2 control-label">Email:</label>
    <div class="col-sm-10"><input type="email" name="email" class="form-control" placeholder="Email" value="{{isset($publicacion->email) ? $publicacion->email : null}}" maxlength="100" required></div>
</div>
