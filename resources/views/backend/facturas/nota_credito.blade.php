...
@section('title', 'Factura | Nota de Crédito' )
        ...
        <div class="col-lg-12">
            <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox-content p-xl">
                    ...
                    {{ html()->modelForm($factura,'PATCH', route('admin.facturas.storeNotaCredito', $factura))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
                    
                        <div class="row">
                            <div class="form-group col-md-5">
                                {{ html()->label('Fecha')->for('fecha') }}
                                <input type="date" class="form-control" name="fecha_nota" value={{ date('Y-m-d') }} required>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-5 col-md-push-1"></div>
                        </div>
