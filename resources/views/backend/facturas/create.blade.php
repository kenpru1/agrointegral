...
@section('content')
{{ html()->form('POST', route('admin.facturas.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
    <div>
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Crear Factura | Nro. Provisional:
                                <b> {{ $nroProv }}</b>
                            </h5>
                               ...
                               <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-5 ">
                                      ...
                                      <!-- <input type="checkbox" id="entrada_libre" name="entrada_libre" value="true" /> -->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group m-b"><span class="input-group-addon">$</span> 
                                                <input type="number" class="form-control" id="total" name="total" min="0" step="any" readonly></div>
                        ...
                        <div class="col-md-5">   
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class=" col-md-10 col-sm-10 col-xs-12">
                                            <input type="number" class="form-control" id="porcentaje_descuento" name="porcentaje_descuento" value="0.00">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-group m-b"><span class="input-group-addon">$</span> 
                                            <input type="number" class="form-control" id="descuento" name="descuento"  value="0.00" readonly>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-group m-b"><span class="input-group-addon">$</span> 
                                            <input type="number" class="form-control" id="total_presupuesto" name="total_presupuesto" value="0.00" readonly>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
