...
@section('title', 'Rodeos | Mostrar' )

@section('content')
{{ html()->modelForm($rodeo, 'PATCH', route('admin.rodeos.update',$rodeo))->class('form-horizontal')->open() }}
      <div>
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Administración de Tipo de Rodeos
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="mail-body text-right tooltip-demo">
                                ...
                                <a class="btn btn-white btn-sm" href="{{route('admin.rodeos.index')}}" >@lang('buttons.general.cancel')</a>
