...
@section('title', 'Contactos' . ' | ' . 'Ver')

@section('content')
    {{ html()->modelForm($contacto, 'PATCH', route('admin.contactos.update', $contacto))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
        <div>
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group col-md-5">
                                {{ html()->label('Cliente Proveedor')->for('cliente_proveedor_id') }}
                        ...
                        <div class="row">
                            @if($contacto->foto != null)
                                <div class="form-group col-md-5">
                                    <img src="{{ url($contacto->foto) }}" width="150" height="150">
                                </div>
                            @endif
                        </div>
