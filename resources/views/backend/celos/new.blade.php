            ...
            <form class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group col-md-5 ">
                        ...
                        <input type="text" class="form-control" name="nombre" value="{{ $animal->nombre }}" readonly>
                        <input type="hidden" class="form-control" name="animal_id" value="{{ $animal->id }}" readonly>
                    </div>
                    <!--form-group-->
