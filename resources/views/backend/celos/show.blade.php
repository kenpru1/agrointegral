            ...
            <form class="form-horizontal">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5 col-md-push-1">
                        ...
                        <input type="date" class="form-control" name="fecha_deteccion" value="{{isset($celo->fecha_deteccion)?$celo->fecha_deteccion->format('Y-m-d'):date('Y-m-d') }}" required readonly>
