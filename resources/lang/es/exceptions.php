    ...
    */
    ...
    'backend' => [
        'access' => [
            ...
            'permissions' => [
                'already_exists'    => 'Este Permiso ya existe. Por favor, especifique un nombre de Permiso diferente.',
                'cant_delete_admin' => 'No puede eliminar el Permiso de Administrador.',
                ...
                'has_users'         => 'No puede eliminar un Permiso que tenga usuarios asignados.',
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend'            => 'Su cuenta no ha sido verificada todavía. Por favor, revise su e-mail',
