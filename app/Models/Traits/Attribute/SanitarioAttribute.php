...
trait SanitarioAttribute
{
    ...
    {
        return '<a href="'.route('admin.sanitarios.edit', $this).'" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.sanitarios.destroy', $this).'"
             id="'.$this->name.'" 
			 data-method="delete"
