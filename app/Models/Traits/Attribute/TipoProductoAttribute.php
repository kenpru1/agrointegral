...
trait TipoProductoAttribute
{
    ...
    {
        return '<a href="'.route('admin.tipo_productos.edit', $this).'" class="btn btn-primary"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.tipo_productos.destroy', $this).'"
             id="'.$this->name.'" 
			 data-method="delete"
