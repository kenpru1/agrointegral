...
trait OrdenTrabajoAttribute
{
    ...
    {
        if( isset($this->requerimientos->orden_trabajo_id) ) {
            return '<a href="" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.editDisabled') . '"></i></a>';            
        }else{
            return '<a href="' . route('admin.ordenTrabajos.edit', $this) . '" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';
        }
    }
    ...
    public function getDeleteButtonAttribute()
    {
        ...
        if( isset($this->requerimientos->orden_trabajo_id) ) {
            ...
            return '<a href="' . route('admin.ordenTrabajos.destroy', $this) . '"
             id="' . $this->name . '"
             data-method="delete"
    ...
    {
        return '<a href="' . route('admin.ordenTrabajos.show', $this) . '" ><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="Ver"></i></a>';
    }

    public function getPrintButtonAttribute()
    {
        return '<a href="' . route('admin.ordenTrabajos.print', $this) . '" target="_blank"  ><i class="fa fa-download" data-toggle="tooltip" data-placement="top" title="PDF"></i></a>';
    }
    ...
    /**
    * Obtener el numero y cliente de la OrdenTrabajo.
    *
    * @return string
    */
