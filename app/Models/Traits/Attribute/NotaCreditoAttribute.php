...
trait NotaCreditoAttribute
{
   ...
   /* public function getEditButtonAttribute()
    ...
    {
        return '<a href="' . route('admin.notascredito.print', $this) . '" target="_blank"  ><i class="fa fa-download" data-toggle="tooltip" data-placement="top" title="PDF"></i></a>';
    }
