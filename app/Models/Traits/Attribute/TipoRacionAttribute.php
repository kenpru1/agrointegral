...
trait TipoRacionAttribute
{
    ...
    public function getEditButtonAttribute()
    {
        if(auth()->user()->hasRole('administrator')){
            return '<a href="' . route('admin.tipo_raciones.edit', $this) . '" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';
    ...
    {   
        ...
        if(auth()->user()->hasRole('administrator')){
            return '<a href="' . route('admin.tipo_raciones.destroy', $this) . '"
             id="' . $this->name . '"
             data-method="delete"
