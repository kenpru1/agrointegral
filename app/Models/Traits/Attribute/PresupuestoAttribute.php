...
trait PresupuestoAttribute
{
    ...
    public function getEditButtonAttribute()
    {
        ...
        if( isset($this->requerimientos->presupuesto_id) ) {
            return '<a href="" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.editDisabled') . '"></i></a>';            
        }else{
            return '<a href="' . route('admin.presupuestos.edit', $this) . '" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="' . __('buttons.general.crud.edit') . '"></i></a>';            
    ...
    public function getDeleteButtonAttribute()
    {
        if( isset($this->requerimientos->presupuesto_id) ) {
            ...
            return '<a href="' . route('admin.presupuestos.destroy', $this) . '"
             id="' . $this->name . '"
             data-method="delete"
    ...
    {
        return '<a href="' . route('admin.presupuestos.show', $this) . '" ><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="Ver"></i></a>';
    }

    public function getPrintButtonAttribute()
    {
        return '<a href="' . route('admin.presupuestos.print', $this) . '" target="_blank"  ><i class="fa fa-download" data-toggle="tooltip" data-placement="top" title="PDF"></i></a>';
    }
    ...
    /**
    * Obtener el numero y cliente de la coizacion.
    *
    * @return string
    */
