...
trait CorrelativoAttribute
{
    ...
    {
        return '<a href="'.route('admin.correlativos.edit', $this).'" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"></i></a>';
    }
